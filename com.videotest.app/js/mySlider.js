...
var Slider = (function ($) {
    ...
    var module = {
        ...
        config: function (config) {
            ...
            module.timeArray      = config.timeArray || [];
        },
        early: function () {
            var self   = this,
                slider = self.target,
        ...
        auto: function () {
            var self = this;
            var tempTime = self.timeArray[module.npos];
            if(!tempTime){
                tempTime = module.time;
            }
            //self.timer = setTimeout(self.next,tempTime);
        },
        pager: function () {
            var nav = $('<ul class="slider-nav"><li><a class="control prev"></a></li><li><a class="control next"></a></li></ul>');
            return nav;
        },
        items: function (i) {
